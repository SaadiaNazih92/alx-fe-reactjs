...
import { Link } from 'react-router-dom'; // <--- Assicurati che questo ci sia!
...
const HomePage = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      {/* --- INIZIO NUOVO CODICE --- */}
      {/* Incolla questo pezzo TRA il titolo e la griglia */}
      ...
      {/* Qui sotto c'è la tua griglia che avevi già, NON cancellarla */}
